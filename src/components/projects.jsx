                ...
                <section className='mt-4 mb-2'>
                    <div className="card det">
                        <div className="card-body ">
                            ...
                            <p className="proj-1 card-text">This is web based demonstration of Arithmetic calculation test. This project contains three tests. Addition, Subtraction and Multiplication test.it has the question, so user enter it's correct value. If that answer is correct then score would be increased otherwise it woudn't and next question also won't appear until user enter the correct answer.</p>
